...
// Jean Koechlin
    ...
    const Jean_Koechlin_portfolioItems = [Jean_Koechlin_portfolioItem0, Jean_Koechlin_portfolioItem1]; 
...
// Salome Koechlin
	const [
	  ...
	  Salome_Koechlin_portfolioItem1Texture,
    ] = await loadTextures([
      './images/portfolio/icons/left.png',
      './images/portfolio/icons/right.png',
      './images/Salome_Koechlin_01.jpg',
	  './images/Salome_Koechlin_02.jpg',
    ]);
	...
	const Salome_Koechlin_portfolioItem1Material = new THREE.MeshBasicMaterial({map: Salome_Koechlin_portfolioItem1Texture});
	...
	const Salome_Koechlin_portfolioItem1 = new THREE.Mesh(Salome_Koechlin_planeGeometry, Salome_Koechlin_portfolioItem1Material); 
    ...
    const Salome_Koechlin_portfolioItems = [Salome_Koechlin_portfolioItem0, Salome_Koechlin_portfolioItem1]; 
